...
func Run(args []string) {
	...
	flag.StringVar(&keywordStatsCSV, "keyword_stats_csv", "data/apple_ads_search_keywords_by_day.csv", "path to keyword stats by day CSV (used to compute campaign baselines for impression share)")
	flag.StringVar(&searchTermStatsCSV, "search_term_stats_csv", "data/apple_ads_search_terms_by_day.csv", "path to search term stats by day CSV")
